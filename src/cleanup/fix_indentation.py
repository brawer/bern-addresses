            ...
            for line in open(vol, "r"):
                ...
                if indent_toggle:
                    if (
                        ...
                        or trim(line.split(",")[0]) in givennames
                    ):
                        out.write(f"- {line}\n")
                        continue
                ...
                if trim(ws_splits[0]) in lastnames and trim(ws_splits[1]) in givennames:
                ...
                if (
                    trim(comma_splits[0]) in lastnames
                ...
                if (
                    trim(ws_splits[0]) in givennames
